    ...
    <section className="hero">
      <div className="container-fluid">
        ...
        <div className="content">
          <h2>Explore<br /><span>CoolCriminal_Universe NFTs</span></h2>
          ...
          <div className="container panel">
            <div className="row">
              ...
              <div className="col">
                <img className="img tertiary-image" src={require('../images/02.png')} alt="02" />
              ...
              <div className="col">
                ...
                <img className="img tertiary-image" src={require('../images/06.png')} alt="06" />
              </div>
              <div className="col">
